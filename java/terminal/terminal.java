...
public class terminal {
  ...
  static int matchStringCounter=0;
  static String scanOutString=""; 
  public static void scanSerial(String inputString){
	String testString="yaw= "; 
	//static int matchStringCounter=0;
	for (int i=0;i<inputString.length();i++){
	  if (matchStringCounter>=testString.length()){
		  if(inputString.charAt(i)=='\n'){
		    System.out.print(scanOutString);
		    scanOutString+=inputString.substring(i,i+1);
		    scanOutString="yaw="+scanOutString;
		    fileOut(scanOutString,"yaw.dat");
	  ...
	  else if(inputString.charAt(i)==testString.charAt(matchStringCounter)){
	         matchStringCounter++;
	       }
	       else {
	         matchStringCounter=0;
  ...
  static void readFile(String fileName){
    ...
    try {
      ...
      while (myReader.hasNextLine()) {
        ...
        int starting =data.indexOf("=");
        int ending=data.indexOf(",",starting);
